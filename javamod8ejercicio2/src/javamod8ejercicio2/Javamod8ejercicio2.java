...
public class Javamod8ejercicio2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("llenando cafe");
        c1.llenarCafetera();
        System.out.println("cuanto volumen tiene su taza");
        c1.servirTaza(leer.nextDouble());
        System.out.println("vaciando cafetera");
        c1.vaciarCafetera();
        System.out.println("¿ cuanto agrega de cafe ?");
        c1.agregarCafe(leer.nextDouble());
    }
