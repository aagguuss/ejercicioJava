 ...
 */
package javamod9.pkg5;

import PaisesServicee.PaisesService;

/**
 *
 * @author agust
 */
public class Javamod105 {
...
* le preguntará al usuario si quiere guardar otro país o si quiere salir,si decide salir,
* se mostrará todos los países guardados en el conjunto. 
...
* se buscará el país en el conjunto y si está en el conjunto se eliminará el 
* país que ingresó el usuario y se mostrará el conjunto. 
* Si el país no se encuentra en el conjunto se le informará
al usuario.
