 ...
 * @author agust
 */
public class Javamod9ejercicio1 {

    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
        System.out.println("estas en el comienzo del main");
      parDeNumerosService s1 = new parDeNumerosService();
      //ddouble may , men;
      s1.mostrarValores();
      //may=s1.devolverMayor();
      s1.calcularPotencia();
      s1.calculaRaiz();
    }
